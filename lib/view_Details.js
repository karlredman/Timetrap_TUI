...
var {DetailsMenubar} = require('./widget_DetailsMenubar');
var {DetailsMenubarConfig} = require('./widget_DetailsMenubarConfig');
var {DetailsTable} = require('./widget_DetailsTable');
var {DetailsTableConfig} = require('./widget_DetailsTableConfig');
...
class ViewDetails extends EventEmitter {
  constructor({
    ...
    this.timetrap = new Timetrap({watched_db_file: this.process_config.data.database_file});
...
ViewDetails.prototype.createWidgets = function() {
  ...
  // status box
  const details_status_config = new DetailsStatusConfig();
  ...
  // menubar
  const menubar_config = new DetailsMenubarConfig();
  ...
  // details table
  const details_table_config = new DetailsTableConfig();
