...
class DetailsMenubarConfig extends ConfigurationBase {
  constructor({config_file = null, config_options = null} = {}) {
    super({root_title: 'Timetrap_TUI', title: 'DetailsMenubarConfig', config_options: config_options});
  }
}

// NOTE: bug issue(?!) nulls over "none"
DetailsMenubarConfig.prototype.loadDefaults = function() {
  this.data = {
    colors: {
      bg: {
        none: null,
...
module.exports = {DetailsMenubarConfig};
